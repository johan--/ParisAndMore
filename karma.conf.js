...
module.exports = function(config) {
    ...
    var browserifyTestFiles = './front/scripts' + entry + '/**/*.test.js';
    var webpackTestFiles = './front/scripts' + entry + '/tests.webpack.js';
    ...
    var browserify = {
        ...
        transform: [
            ['browserify-istanbul', {
                ...
                ignore: ['**/*.test.js', '**/*.html', '**/bower_components/**', '**/node_modules/**', '**/front/scripts/lbServices.js']
            }],
            ['babelify', {
                'stage': 0,
